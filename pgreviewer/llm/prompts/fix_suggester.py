...
def _build_prompt(
    ...
    return (
        ...
        "NEVER use f-strings or string interpolation ANYWHERE in the SQL string "
        "— not even for structural parts like WHERE clause templates. "
        "For dynamic WHERE clauses, build with plain string concatenation (`+`) "
        "using only string literals, then pass user values as bound params.\n"
