...
def diff(
    ...
    schema: Path | None = typer.Option(  # noqa: B008
        ...
        "--schema",
        help=(
            "Path to a schema SQL file (e.g. .pgreviewer/schema.sql) generated by"
            " 'pgr schema dump'. When provided, detectors see table/column/index"
            " data from the existing database and can escalate severity accordingly."
            " Auto-detected from .pgreviewer/schema.sql in the current directory"
